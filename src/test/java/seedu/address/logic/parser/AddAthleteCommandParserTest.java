...
public class AddAthleteCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB
                ...
                + ADDRESS_DESC_BOB + EMERGENCY_CONTACT_DESC_BOB + START_DATE_DESC_BOB
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + AGE_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + EMERGENCY_CONTACT_DESC_BOB + START_DATE_DESC_BOB
                + TAG_DESC_FRIEND + AVAILABLE_DAY_DESC_BOB + AVAILABLE_DAY_DESC_BOB;
        ...
        assertParseFailure(parser, START_DATE_DESC_AMY + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_START_DATE));

        // multiple fields repeated
        assertParseFailure(parser,
                validExpectedPersonString + AGE_DESC_AMY + PHONE_DESC_AMY
                        + EMAIL_DESC_AMY + NAME_DESC_AMY + ADDRESS_DESC_AMY
                        + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_AGE,
                        PREFIX_ADDRESS, PREFIX_EMAIL, PREFIX_PHONE, PREFIX_EMERGENCY_CONTACT, PREFIX_START_DATE));
        ...
        // invalid start date
        assertParseFailure(parser, INVALID_START_DATE_DESC + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_START_DATE));
        ...
        // invalid start date
        assertParseFailure(parser, validExpectedPersonString + INVALID_START_DATE_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_START_DATE));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + VALID_AGE_BOB + VALID_PHONE_BOB
                        + VALID_EMAIL_BOB + VALID_ADDRESS_BOB + VALID_START_DATE_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + AGE_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + EMERGENCY_CONTACT_DESC_BOB + START_DATE_DESC_BOB
        ...
        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + AGE_DESC_BOB + INVALID_PHONE_DESC
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + EMERGENCY_CONTACT_DESC_BOB + START_DATE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + AGE_DESC_BOB + PHONE_DESC_BOB
                + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB + EMERGENCY_CONTACT_DESC_BOB + START_DATE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + AGE_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC + EMERGENCY_CONTACT_DESC_BOB + START_DATE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Address.MESSAGE_CONSTRAINTS);

        // invalid emergency contact
        assertParseFailure(parser, NAME_DESC_BOB + AGE_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + INVALID_EMERGENCY_CONTACT_DESC + START_DATE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, EmergencyContact.MESSAGE_CONSTRAINTS);

        // invalid start date
        assertParseFailure(parser, NAME_DESC_BOB + AGE_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + EMERGENCY_CONTACT_DESC_BOB + INVALID_START_DATE_DESC
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, StartDate.MESSAGE_CONSTRAINTS);
