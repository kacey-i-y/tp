...
public class AddressBookParserTest {
    ...
    public void parseCommand_delete() throws Exception {
        DeleteAthleteCommand command = (DeleteAthleteCommand) parser.parseCommand(
                DeleteAthleteCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased());
        assertEquals(new DeleteAthleteCommand(INDEX_FIRST_PERSON), command);
    }
    ...
    public void parseCommand_find() throws Exception {
        assertTrue(parser.parseCommand(FindCommand.COMMAND_WORD + " " + PREFIX_NAME + "foo bar baz")
